    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
          ...
          <button
            className="lg:hidden p-2 text-foreground rounded-full relative z-[60]"
      ...
      {mobileMenuOpen && (
        <div
          className="fixed inset-0 bg-white z-[55] lg:hidden flex flex-col pt-28 px-6 pb-8"
        ...
        >
          ...
          <div className="mt-auto pt-8">
            <Link href="/zrp" onClick={() => setMobileMenuOpen(false)}>
              <Button className="w-full h-14 text-lg" data-testid="mobile-cta-zrp">
                Découvrir le programme ZRP
              </Button>
            </Link>
          </div>
