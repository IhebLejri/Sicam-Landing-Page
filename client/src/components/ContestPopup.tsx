      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Barre de boutons collée sous l'image */}
            <div className="flex rounded-b-2xl overflow-hidden">
              <a
                ...
                onClick={e => e.stopPropagation()}
                className="flex-1 flex items-center justify-center gap-2 py-3 bg-[#1877F2] hover:bg-[#1565d8] text-white text-sm font-bold transition-colors"
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={e => e.stopPropagation()}
                className="flex-1 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-[#e6683c] to-[#bc1888] hover:opacity-90 text-white text-sm font-bold transition-opacity"
