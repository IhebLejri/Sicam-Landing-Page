          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden">
              ...
              <a
                ...
                onClick={e => e.stopPropagation()}
                className="absolute z-20 flex items-center justify-center w-[4%] aspect-square rounded-lg bg-[#1877F2] hover:bg-[#1565d8] shadow-md hover:scale-110 transition-all"
